-- Multi-Company Operational Structure Schema (Fixed)
...
-- Create indexes for better performance (only for tables that exist)
...
-- Create a simplified division summary view (only for existing tables)
